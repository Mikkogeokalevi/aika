document.addEventListener('DOMContentLoaded', function() {
    ...
    // TÄMÄ ON KORJATTU VERSIO, JOSSA VIIMEISEN LAUSEEN 'o' ON VAIHDETTU 'ö':KSI (00f6).
    let sentencesHex = [
